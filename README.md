...
* [django-nested-admin](https://github.com/theatlantic/django-nested-admin) is a project that makes it possible to nest admin inlines (that is, to define inlines on InlineModelAdmin classes).
